...
function extractOrderFields(row) {
  return {
    ...
    kelurahan  : getCol(row, 'Kelurahan', 'kelurahan', 'Kel', 'Kel.', 'Kelurahan/Desa', 'Desa/Kelurahan', 'Desa'),
    kecamatan  : getCol(row, 'Kecamatan', 'kecamatan', 'Kec', 'Kec.', 'Kecamatan/Desa'),
    kabupaten  : getCol(row, 'Kabupaten', 'kabupaten', 'Kabupaten/Kota', 'Kab/Kota', 'Kab.', 'Kota/Kabupaten', 'Kota'),
    ...
    quantity: getCol(row, 'Quantity', 'Qty', 'quantity', 'qty'),
    pembayaran : getCol(row, 'Pembayaran', 'pembayaran', 'payment'),
    total_pembayaran : getCol(row, 'Total Pembayaran', 'TotalPembayaran', 'Total', 'total'),
